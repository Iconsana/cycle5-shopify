// This file will handle both /api/templates and /api/templates/[id] requests
...
export default function handler(req, res) {
  ...
  // Return a specific template if ID is provided
  if (id) {
  ...
  return res.json({ success: true, data: templatesWithoutContent });
}
