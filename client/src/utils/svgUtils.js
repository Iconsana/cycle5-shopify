/**
 * SVG utilities for template processing
 * This file exists to solve import resolution issues
 */

console.log("Loading svgUtils from utils directory - this is the correct file!");
